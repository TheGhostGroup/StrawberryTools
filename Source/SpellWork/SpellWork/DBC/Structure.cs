...
namespace SpellWork
{
    ...
    {
        public uint Id;                                           // 0        m_ID
        public float MaxTargetRadius;                             //          m_maxTargetRadius
    ...
    public struct SpellEntry
    {
        ...
        public uint    AttributesEx7;                                // 8        m_attributesExG 3.2.0 (0x20 - totems, 0x4 - paladin auras, etc...)
        public uint    AttributesEx8;                                // 9        m_attributesExH
        public uint SomeFlags;                                       // 10        4.0.0
        public uint Unk_400_1;                                       // 11       4.0.0
        ...
        public uint _SpellName;                                      // 21       m_name_lang
        public uint _Rank;                                           // 22       m_nameSubtext_lang
        public uint _Description;                                    // 23       m_description_lang not used
        public uint _ToolTip;                                        // 24       m_auraDescription_lang not used
    ...
    public struct SkillLineEntry
    {
        ...
        //public uint SkillCostID;                                 // 2        m_skillCostsID removed in 4.3.0?
